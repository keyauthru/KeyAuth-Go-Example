...
func main() {
	...
	* Get Public Variables * - https://keyauth.ru/dashboard/app/variables/
	...
	* Webhooks * - https://keyauth.ru/dashboard/app/webhooks/
	...
	* Logs * - https://keyauth.ru/dashboard/app/settings/
